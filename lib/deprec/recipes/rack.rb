...
Capistrano::Configuration.instance(:must_exist).load do
  namespace :deprec do
    namespace :rack do
      ...
      desc "Install Rack stack on Ubuntu server (8.04, 10.04, 12.04)"
      task :install_stack do
        ...
        apt.install( { :base => %w(libmysqlclient15-dev sqlite3 ruby-sqlite3 libsqlite3-dev libpq-dev libxml2-dev libxslt-dev) }, :stable)
